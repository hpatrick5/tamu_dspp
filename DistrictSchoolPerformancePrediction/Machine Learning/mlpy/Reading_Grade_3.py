...
mapping = {'English': 1, 'Spanish': 0}
df4 = df4.replace({'Language': mapping})
...
cols.pop(cols.index('Final STAAR')) #Remove b from list
df5 = df4[cols+['Final STAAR']] #Create new dataframe with columns in the order you want
#len(df_new2.columns)
df5
...
#export to excel
df6.to_csv(r'/Users/sukanyasravasti/LR_Reading_Grade3.csv', index = False)
